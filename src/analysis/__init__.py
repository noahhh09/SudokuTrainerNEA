...
from src.analysis.techniques.HiddenGroup import HiddenPair, HiddenTriple
...
ALL_TECHNIQUE_TYPES: list[type[Technique]] = [NakedSingle, HiddenSingle, NakedPair, PointingGroup, NakedTriple, HiddenPair, HiddenTriple]